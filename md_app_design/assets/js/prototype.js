...
$(function() {
  ...
  // Tap: close (FlowB4-认证完成通知) -> D01登录@注册认证用户-审核中_Checking
  $("#a9QICSR_DSuiA872-jtjecg").on("tapone", function(event) {
    screenTransition.slideRight("ZdeNVi2kRr2N5IsGB2BRzg", "a0JqWSPHfTeOkOKxGnHwMog");
    event.stopPropagation();
  });
